        ...
        if (length && length > 2 && data[0] == '4' && data[1] == '2') {
            ...
            if (s != "") {
                ...
                if (event == "telemetry") {
                        ...
                        if (d > (4*(lane+0)) && d < (4*(lane+1))) {
                            ...
                            if ((check_car_s > (car_s - 20)) && (check_car_s < (car_s + 30))) {
                                ...
                                left_too_close = true;
										...
										// logic for changing lanes:
                    if (too_close) {
                        ref_vel -= .336; // .224 ~ 0.5 mph
                        ...
                        if (lane == 0 && !right_too_close) {
                            ...
                            lane = 1;
													...
													// slow down if current and right lane is blocked
													ref_vel -= .336; // tweak those parameter to slow down faster or/and (further achievment) get vel of the car infront
												}
                            ...
                            lane = 1;
												...
												// slow down if current and left lane is blocked 
												else if (lane ==2 && left_too_close){
													ref_vel -= .336; // tweak those parameter to slow down faster or/and (further achievment) get vel of the car infront
												}
                    ...
                    // in frenet add evenly 40 m spaced points ahead of the starting references - testing 45m 
                    ...
                    double target_x = 40.0; // 30 bzw 45 m
